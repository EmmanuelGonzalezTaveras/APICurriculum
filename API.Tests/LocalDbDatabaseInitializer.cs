...
namespace API.Tests
{
	//solo se debe utilizar en windows, no funciona en mac
	//[TestClass]
 ...
 //           var options = new DbContextOptionsBuilder<ApplicationDbContext>()
 //              .UseSqlServer($"Server=velocreditos.ddns.net,1311;Database={_dbName};User=sa;Password=$2@AS$d54D325G@fgdf$UJIOh5g$hdrfd@SESgyujgyhbjmhjfcghnnfggf658fg7567tf75tyjk90t56jkuyt67tyhu767seer544g;TrustServerCertificate=True",
 //              x => x.UseNetTopologySuite())
 //              .Options;
